                    ...
                    ?>
                        <form method="post">
                            <div class="row">
                                ...
                                <div class="col-sm-4">
                                    <div class="form-group">
                                        <label class="floating-label" for="Text">Adddress</label>
                                        <input type="text" name="address" class="form-control" id="Text" placeholder="Address" <?php echo 'value="' . $address . '"'; ?>>
                                    </div>
                                </div>
                                <div class="col-sm-4">
                                    <div class="form-group">
                                        <label class="floating-label" for="Email">Telephone Number</label>
                                        <input type="text" name="tpnumber" class="form-control" id="tpnumber" placeholder="Telephone Number" <?php echo 'value="' . $tpnumber . '"'; ?>>
                                    </div>
                                </div>
                                <!-- <div class="col-sm-4">
                                    <div class="form-group">
