...
if (isset($_POST['submit'])) {
	...
	if (empty($errors)) {
		...
		if (mysqli_num_rows($result_set) == 1) {
			...
			$query .= "WHERE admin_id = {$_SESSION['user_id']} LIMIT 1";
...
<head>
	...
	<title>OZONE | Admin Signin</title>
	<!-- Meta -->
	<meta charset="utf-8">
					...
					<div class="col-md-12">
						<div class="card-body">
							<form action="login.php" method="post">
								<h4 class="mb-3 f-w-400">Admin Sign in</h4>
								...
								<div class="form-group mb-3">
									<input type="text" name="first_name" class="form-control" id="Email" placeholder="First Name" required>
								</div>
								<div class="align-items-center text-left">
