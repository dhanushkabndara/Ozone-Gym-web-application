		...
		<div class="navbar-wrapper  ">
			<div class="navbar-content scroll-div " >
				...
				<ul class="nav pcoded-inner-navbar ">
					...
					<li class="nav-item pcoded-hasmenu">
					    <a href="#" class="nav-link "><span class="pcoded-micon"><i class="feather icon-eye"></i></span><span class="pcoded-mtext">Session Logs</span></a>
					    <ul class="pcoded-submenu">
					        <li><a href="member_sessions.php" class="nav-link ">Member Sessions</a></li>
					        <li><a href="manager_sessions.php" class="nav-link">Manager Sessions</a></li>
					    </ul>
					</li>
				</ul>
